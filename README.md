...
We have configured a specific Launch Task for VS Code to make running the game easier.

1.  Click the **Run and Debug** icon in the left Sidebar (it looks like a Play button with a Bug).
2.  At the top of the side panel, ensure **"Play Game"** is selected in the dropdown.
3.  Click the **Green Play Button** next to it (or press `F5`).

This will automatically start the dev server and open Chrome to your game.
